...
class ErrorBoundary extends React.Component {
  ...
  render() {
    if (this.state.hasError) {
      return (
        <div className="min-h-screen bg-white flex items-center justify-center p-6 font-mono text-left z-50 relative">
          <div className="bg-red-900/20 border border-red-500/30 p-8 rounded-2xl max-w-4xl w-full">
            ...
            <button onClick={() => window.location.reload()} className="mt-8 px-6 py-3 bg-slate-50 hover:bg-slate-100 text-slate-900 rounded-xl font-bold transition-colors w-full sm:w-auto">Reload Application</button>
          </div>
        </div>
      );
    }
